...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	...
	if(isset($_POST["addToCart"])){
		...
		if($count > 0){
			...
			$session["cart"] = $p_id;
			$sql = "SELECT id FROM cart WHERE ip_add = '$ip_add' AND p_id = '$p_id' AND user_id = '$ip_add' ";
			$query = mysqli_query($con,$sql);
				...
				echo '
                    ...
                    <div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="pro	duct-price"><span class="qty">'.$n.'</span>$'.$product_price.'</h4>
												</div>
...
/*$sql = "UPDATE cart SET qty=qty+1 WHERE p_id = '$p_id' AND user_id = -1";
